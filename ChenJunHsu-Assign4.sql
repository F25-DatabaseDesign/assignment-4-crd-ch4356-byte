-- MySQL dump for United Helpers Database
-- Database Design Assignment 4
-- Created: 2025-10-15
...
('Sarah Johnson', '123 Main Street, New York, NY 10001', '212-555-0101'),
('Michael Chen', '456 Oak Avenue, Brooklyn, NY 11201', '718-555-0202'),
('Emily Rodriguez', '789 Elm Street, Queens, NY 11354', '347-555-0303'),
('David Williams', '321 Pine Road, Manhattan, NY 10002', '212-555-0404'),
('Jessica Martinez', '654 Maple Drive, Bronx, NY 10451', '718-555-0505'),
('James Thompson', '987 Cedar Lane, Staten Island, NY 10301', '718-555-0606'),
('Maria Garcia', '147 Birch Street, Brooklyn, NY 11215', '347-555-0707'),
('Robert Anderson', '258 Walnut Avenue, Queens, NY 11377', '718-555-0808'),
('Jennifer Lee', '369 Spruce Court, Manhattan, NY 10003', '212-555-0909'),
('Christopher Taylor', '741 Ash Boulevard, Bronx, NY 10463', '718-555-1010'),
('Amanda White', '852 Hickory Place, Brooklyn, NY 11220', '347-555-1111'),
('Daniel Harris', '963 Poplar Street, Queens, NY 11365', '718-555-1212');
...
(1, 1, '2025-01-15', 6.00),
(1, 1, '2025-01-15', 5.80),
(2, 3, '2025-01-16', 12.50),
(2, 3, '2025-01-16', 13.00),
(2, 3, '2025-01-16', 12.75),
(2, 3, '2025-01-16', 12.25),
(4, 4, '2025-01-13', 4.50),
(4, 4, '2025-01-13', 4.75),
(4, 4, '2025-01-13', 4.60),
(11, 3, '2025-01-21', 13.20),
...
('Rice 2lb bag', 3.00, 800),
('Pasta box', 2.25, 900),
('Bottled water pack', 4.00, 1200),
('Canned beans', 1.75, 950),
('Bar soap', 1.25, 600),
('Toothpaste tube', 2.00, 450),
('Toothbrush', 1.00, 500),
('Shampoo bottle', 3.50, 350),
('Hand towel', 4.00, 400);
